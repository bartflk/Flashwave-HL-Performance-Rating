...
pub async fn fights_card(
    ...
    let lines = vec![
        ...
        line(
            "Deaths traded",
            "% of your deaths",
            share(&mine, "traded_deaths", "deaths"),
            share(&pool, "traded_deaths", "deaths"),
            1,
        ...
        line(
            ...
            "per 10 min",
            per10(&mine, "deaths_to_sniper"),
            per10(&pool, "deaths_to_sniper"),
            -1,
        ...
        line(
            "Deaths to flankers",
            "per 10 min",
            per10(&mine, "deaths_to_flank"),
            per10(&pool, "deaths_to_flank"),
            -1,
        ...
        line(
            "Stayed put and died",
            "per 10 min",
            per10(&mine, "stationary_deaths"),
            per10(&pool, "stationary_deaths"),
            0,
